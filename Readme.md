# Mtg Tournament access data to mysql
...
> Technology: Python + access + xml + json + beautifoulsoup
> Transform access data to xml and json files to import on mysql.  Adding extra info from websites (scrapping with python)
